...
| `manufacturing_share` | `NV.IND.MANF.ZS` | `world_bank_wdi` | Manufacturing value added share | Percent of GDP | Lagged prior-year value and lagged three-year mean in model panels | Main predictor | Industrial-capacity / "industrial commons" proxy (Cohen & Zysman 1987; Pisano & Shih 2009/2012). 203 countries, 1990-2024; near-independent of economic scale (main-panel VIF 1.06). |
...
10. `manufacturing_share` uses World Bank WDI `NV.IND.MANF.ZS` (manufacturing value added as a percent of GDP) as the main-model industrial-capacity predictor.
...
| 2026-06-12 | Added manufacturing value added share as a main predictor | Use World Bank WDI `NV.IND.MANF.ZS` (`manufacturing_share`) as the main-model industrial-capacity predictor; added target-plus-complete-feature sample counts and panel-variable imputation counts. |
